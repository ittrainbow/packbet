...
export const StandingsHeader = () => {
  ...
  return (
    ...
    >
      <span className="flex items-center bg-gray-200 text-sm sm:text-base justify-center rounded-lg px-1 py-0 border border-gray-400">
        #
      </span>
      {seasonSelected !== 2022 && (
        <span className="flex items-center bg-gray-200 text-sm sm:text-base justify-center rounded-lg px-1 py-0 border border-gray-400"></span>
      )}
      <span className="flex items-center bg-gray-200 text-sm sm:text-base justify-center rounded-lg px-1 py-0 border border-gray-400 tracking-tighter">
        {tableNameMsg}
      </span>
      <span className="flex items-center bg-gray-200 text-sm sm:text-base justify-center rounded-lg px-1 py-0 border border-gray-400 tracking-tighter">
