export const Loader = () => {
  return (
    <div className="loader flex pt-8 max-w-24 items-center justify-center absolute top-[calc((100vh-var(--tabbar-height))/2-3rem)] left-[calc(50%-3rem)] h-24 w-24">
      ...
      <div className="inner absolute box-border w-full h-full rounded-[3rem] r-0 top-0  border-r-8 animate-rotate-two border-accent two"></div>
      <div className="inner absolute box-border w-full h-full rounded-[3rem] r-0 bottom-0 border-t-8 animate-rotate-three border-accent three"></div>
    </div>
  )
}
