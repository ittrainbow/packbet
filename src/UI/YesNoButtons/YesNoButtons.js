...
export const YesNoButtons = ({ total, id, activity, onClick, disabled, admin }) => {
  return (
    <div className="yn__parent">
      <button
        className={activity === 1 ? (admin ? 'yn__btn dark' : 'yn__btn green') : 'yn__btn grey'}
      ...
      <button
        className={activity === 2 ? (admin ? 'yn__btn dark' : 'yn__btn red') : 'yn__btn grey'}
